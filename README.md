...
- 📚 Documentación de las dependencias utilizadas.
- 🔗 Referencias de las bibliotecas empleadas.
...
1. Instale las dependencias descritas en **Dependencias.md**.
2. Abra el archivo **notebook.ipynb** utilizando **Jupyter Notebook**.
3. Ejecute las celdas del cuaderno en orden para visualizar la simulación.
